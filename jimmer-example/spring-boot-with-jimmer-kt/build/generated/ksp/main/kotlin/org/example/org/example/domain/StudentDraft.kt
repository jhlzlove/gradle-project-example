...
public interface StudentDraft : Student, BaseEntityDraft {
    ...
    public object `$` {
        ...
        public fun produce(base: Student? = null): Student {
            val consumer = DraftConsumer<StudentDraft> {}
...
@GeneratedBy(type = Student::class)
public fun ImmutableCreator<Student>.`by`(block: StudentDraft.() -> Unit): Student =
        StudentDraft.`$`.produce(null, block)

@GeneratedBy(type = Student::class)
public fun ImmutableCreator<Student>.`by`(base: Student?): Student = StudentDraft.`$`.produce(base)

@GeneratedBy(type = Student::class)
public fun ImmutableCreator<Student>.`by`(base: Student?, block: StudentDraft.() -> Unit): Student =
        StudentDraft.`$`.produce(base, block)

@GeneratedBy(type = Student::class)
public operator fun ImmutableCompanion<Student>.invoke(block: StudentDraft.() -> Unit): Student =
        StudentDraft.`$`.produce(null, block)

@GeneratedBy(type = Student::class)
public operator fun ImmutableCompanion<Student>.invoke(base: Student?,
        block: StudentDraft.() -> Unit): Student = StudentDraft.`$`.produce(base, block)

@GeneratedBy(type = Student::class)
public fun MutableList<StudentDraft>.addBy(block: StudentDraft.() -> Unit):
        MutableList<StudentDraft> {
    add(StudentDraft.`$`.produce(null, block) as StudentDraft)
    return this
}

@GeneratedBy(type = Student::class)
public fun MutableList<StudentDraft>.addBy(base: Student?): MutableList<StudentDraft> {
    add(StudentDraft.`$`.produce(base) as StudentDraft)
    return this
}

@GeneratedBy(type = Student::class)
public fun MutableList<StudentDraft>.addBy(base: Student?, block: StudentDraft.() -> Unit):
        MutableList<StudentDraft> {
