...
public interface CourseDraft : Course, Draft {
    ...
    public object `$` {
        ...
        public fun produce(base: Course? = null): Course {
            val consumer = DraftConsumer<CourseDraft> {}
...
@GeneratedBy(type = Course::class)
public fun ImmutableCreator<Course>.`by`(block: CourseDraft.() -> Unit): Course =
        CourseDraft.`$`.produce(null, block)

@GeneratedBy(type = Course::class)
public fun ImmutableCreator<Course>.`by`(base: Course?): Course = CourseDraft.`$`.produce(base)

@GeneratedBy(type = Course::class)
public fun ImmutableCreator<Course>.`by`(base: Course?, block: CourseDraft.() -> Unit): Course =
        CourseDraft.`$`.produce(base, block)

@GeneratedBy(type = Course::class)
public operator fun ImmutableCompanion<Course>.invoke(block: CourseDraft.() -> Unit): Course =
        CourseDraft.`$`.produce(null, block)

@GeneratedBy(type = Course::class)
public operator fun ImmutableCompanion<Course>.invoke(base: Course?, block: CourseDraft.() -> Unit):
        Course = CourseDraft.`$`.produce(base, block)

@GeneratedBy(type = Course::class)
public fun MutableList<CourseDraft>.addBy(block: CourseDraft.() -> Unit): MutableList<CourseDraft> {
    add(CourseDraft.`$`.produce(null, block) as CourseDraft)
    return this
}

@GeneratedBy(type = Course::class)
public fun MutableList<CourseDraft>.addBy(base: Course?): MutableList<CourseDraft> {
    add(CourseDraft.`$`.produce(base) as CourseDraft)
    return this
}

@GeneratedBy(type = Course::class)
public fun MutableList<CourseDraft>.addBy(base: Course?, block: CourseDraft.() -> Unit):
